...
###  DBG-MACRO
#################
set(CONAN_DBG-MACRO_ROOT "/Users/akide/.conan/data/dbg-macro/0.4.0/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_DBG-MACRO "/Users/akide/.conan/data/dbg-macro/0.4.0/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_DBG-MACRO )
set(CONAN_BIN_DIRS_DBG-MACRO )
set(CONAN_RES_DIRS_DBG-MACRO )
set(CONAN_SRC_DIRS_DBG-MACRO )
set(CONAN_BUILD_DIRS_DBG-MACRO "/Users/akide/.conan/data/dbg-macro/0.4.0/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
set(CONAN_FRAMEWORK_DIRS_DBG-MACRO )
set(CONAN_LIBS_DBG-MACRO )
set(CONAN_PKG_LIBS_DBG-MACRO )
set(CONAN_SYSTEM_LIBS_DBG-MACRO )
set(CONAN_FRAMEWORKS_DBG-MACRO )
set(CONAN_FRAMEWORKS_FOUND_DBG-MACRO "")  # Will be filled later
set(CONAN_DEFINES_DBG-MACRO )
set(CONAN_BUILD_MODULES_PATHS_DBG-MACRO )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_DBG-MACRO )

set(CONAN_C_FLAGS_DBG-MACRO "")
set(CONAN_CXX_FLAGS_DBG-MACRO "")
set(CONAN_SHARED_LINKER_FLAGS_DBG-MACRO "")
set(CONAN_EXE_LINKER_FLAGS_DBG-MACRO "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_DBG-MACRO_LIST "")
set(CONAN_CXX_FLAGS_DBG-MACRO_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_LIST "")
set(CONAN_EXE_LINKER_FLAGS_DBG-MACRO_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_DBG-MACRO "${CONAN_FRAMEWORKS_DBG-MACRO}" "_DBG-MACRO" "")
# Append to aggregated values variable
set(CONAN_LIBS_DBG-MACRO ${CONAN_PKG_LIBS_DBG-MACRO} ${CONAN_SYSTEM_LIBS_DBG-MACRO} ${CONAN_FRAMEWORKS_FOUND_DBG-MACRO})


#################
###  GTEST
#################
set(CONAN_GTEST_ROOT "/Users/akide/.conan/data/gtest/1.11.0/_/_/package/8ea16b5437d767794f13beec66099d7352875d19")
set(CONAN_INCLUDE_DIRS_GTEST "/Users/akide/.conan/data/gtest/1.11.0/_/_/package/8ea16b5437d767794f13beec66099d7352875d19/include")
set(CONAN_LIB_DIRS_GTEST "/Users/akide/.conan/data/gtest/1.11.0/_/_/package/8ea16b5437d767794f13beec66099d7352875d19/lib")
set(CONAN_BIN_DIRS_GTEST )
set(CONAN_RES_DIRS_GTEST )
set(CONAN_SRC_DIRS_GTEST )
set(CONAN_BUILD_DIRS_GTEST "/Users/akide/.conan/data/gtest/1.11.0/_/_/package/8ea16b5437d767794f13beec66099d7352875d19/")
...
set(CONAN_DEPENDENCIES dbg-macro gtest fmt)
...
set(CONAN_LIBS gtest_maind gmock_maind gmockd gtestd fmtd ${CONAN_LIBS})
set(CONAN_PKG_LIBS gtest_maind gmock_maind gmockd gtestd fmtd ${CONAN_PKG_LIBS})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES "${CONAN_SYSTEM_LIBS_DBG-MACRO} ${CONAN_FRAMEWORKS_FOUND_DBG-MACRO} ")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_DBG-MACRO}" "${CONAN_LIB_DIRS_DBG-MACRO}"
                                  CONAN_PACKAGE_TARGETS_DBG-MACRO "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES}"
                                  "" dbg-macro)
    set(_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_DBG-MACRO_DEBUG} ${CONAN_FRAMEWORKS_FOUND_DBG-MACRO_DEBUG} ")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_DBG-MACRO_DEBUG}" "${CONAN_LIB_DIRS_DBG-MACRO_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_DBG-MACRO_DEBUG "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_DEBUG}"
                                  "debug" dbg-macro)
    set(_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_DBG-MACRO_RELEASE} ${CONAN_FRAMEWORKS_FOUND_DBG-MACRO_RELEASE} ")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_DBG-MACRO_RELEASE}" "${CONAN_LIB_DIRS_DBG-MACRO_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_DBG-MACRO_RELEASE "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELEASE}"
                                  "release" dbg-macro)
    set(_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_DBG-MACRO_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_DBG-MACRO_RELWITHDEBINFO} ")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_DBG-MACRO_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_DBG-MACRO_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_DBG-MACRO_RELWITHDEBINFO "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" dbg-macro)
    set(_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_DBG-MACRO_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_DBG-MACRO_MINSIZEREL} ")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_DBG-MACRO_MINSIZEREL}" "${CONAN_LIB_DIRS_DBG-MACRO_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_DBG-MACRO_MINSIZEREL "${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" dbg-macro)

    add_library(CONAN_PKG::dbg-macro INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::dbg-macro PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_DBG-MACRO} ${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_DBG-MACRO_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_DBG-MACRO_RELEASE} ${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_DBG-MACRO_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_DBG-MACRO_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_DBG-MACRO_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_DBG-MACRO_MINSIZEREL} ${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_DBG-MACRO_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_DBG-MACRO_DEBUG} ${_CONAN_PKG_LIBS_DBG-MACRO_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_DBG-MACRO_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_DBG-MACRO_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::dbg-macro PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_DBG-MACRO}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_DBG-MACRO_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_DBG-MACRO_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_DBG-MACRO_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_DBG-MACRO_DEBUG}>)
    set_property(TARGET CONAN_PKG::dbg-macro PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_DBG-MACRO}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_DBG-MACRO_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_DBG-MACRO_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_DBG-MACRO_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_DBG-MACRO_DEBUG}>)
    set_property(TARGET CONAN_PKG::dbg-macro PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_DBG-MACRO_LIST} ${CONAN_CXX_FLAGS_DBG-MACRO_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_DBG-MACRO_RELEASE_LIST} ${CONAN_CXX_FLAGS_DBG-MACRO_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_DBG-MACRO_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_DBG-MACRO_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_DBG-MACRO_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_DBG-MACRO_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_DBG-MACRO_DEBUG_LIST}  ${CONAN_CXX_FLAGS_DBG-MACRO_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::dbg-macro CONAN_PKG::gtest CONAN_PKG::fmt)
